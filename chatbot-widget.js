...
function sendInputToGAS3(message, isUserMessage) {
    const GAS_URL3 = 'https://script.google.com/macros/s/AKfycbzbJo82muvK-VjncKVn-Tedm_YNPkc2xFjuRUlCKJTpnnIgs3cDBvTXyT717oZdT4xk/exec'; // Replace with your actual URL
...
function toggleChatbot() {
  ...
  var chatToggle = document.getElementById("chatbot-toggle");
    if (chatWidget.style.display === "none") {
        ...
        chatToggle.style.right = "420px"
        localStorage.setItem('chatbotOpen', 'true');
    } else {
        chatWidget.style.display = "none";
        chatToggle.style.right = "10px";
...
function startConversation() {
    fetch('https://chatbot-for-pel-centre-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-pel-centre-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGAS(message, isUserMessage) {
    var GAS_URL = 'https://script.google.com/macros/s/AKfycbwNzlZsA1d_03JS778lDH1QxbaJmdmRviiuulBneKUDauf1b3nWpqYtFJxd0UpW3MnpNA/exec';
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycby0rBSvqjvyNl3SCTSyhlvkAauMJawUfSCm0OhG27huklmyWlGKC0osK4J2y8v3cPJ0tw/exec';
