...
function sendInputToGAS3(message, isUserMessage) {
    const GAS_URL3 = 'https://script.google.com/macros/s/AKfycbwEYQEK2EG7a50uhqUly9IF2J8uitEey_SGdm2IoVQDYh8HxncfC4xQdiuZD7lE3eMp/exec'; // Replace with your actual URL
...
function startConversation() {
    fetch('https://chatbot-for-kids-city-usa-new-smyrna-beach-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-kids-city-usa-new-smyrna-beach-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGAS(message, isUserMessage) {
    var GAS_URL = 'https://script.google.com/macros/s/AKfycbzlzY4zOZPEJpKbMKY2ZLBYQtPN6irneEpyUDp0b8z-iVDlWpRxDji_8sap9RxDaaP3/exec';
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbwwX2e1rcu40-kjv8SrAWELfCakGZwb6-JrMtp4jvPOpMiqu9cG3I5-a9dStmWZvvdi/exec';
